...
export class LineChartComponent implements OnInit {
    ...
    private initChart(): void {
        ...
        this.width = this.lineWidth ? this.lineWidth : this.svg.attr('width') - this.margin.left - this.margin.right;
        this.height = this.lineHeight ? this.lineHeight : this.svg.attr('height') - this.margin.top - this.margin.bottom;
